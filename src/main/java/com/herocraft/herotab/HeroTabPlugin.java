...
@Plugin(
        ...
        name = "HeroTab",
        version = "1.5.0",
        description = "Tab list unifié et personnalisable pour tout le réseau HeroCraft — header/footer animés, grades (GradePlugin) et factions (FactionPlugin) via MySQL, tri « ton serveur d'abord » avec séparateur",
        authors = {"HeroCraft"}
)
